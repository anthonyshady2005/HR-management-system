...
export default function AttendanceManagementPage() {
  ...
  /* ===================== EDIT ATTENDANCE FROM PERMISSION ===================== */
                          ...
                          <tr key={r._id} className="border-b border-slate-700 hover:bg-slate-700/50">
                            ...
                            <td className="py-3 px-4 text-right">
                              <div className="flex items-center justify-end gap-2">
                                ...
                                {!r.hasMissedPunch && can("canRunOps") && (
                                  <button
                ...
                {correctionRequests.map((req) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isActionableStatus(req.status) && can("canApprove") && (
                ...
                {permissionRequests.map((perm) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isActionableStatus(perm.status) && (can("canAdjust") || can("canApprove")) && (
                        <div className="mt-3 flex items-center justify-end gap-2">
                          {can("canAdjust") && (
                            <button
