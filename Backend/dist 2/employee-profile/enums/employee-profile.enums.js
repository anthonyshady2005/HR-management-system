...
exports.ProfileChangeStatus = exports.GraduationType = exports.CandidateStatus = exports.SystemRole = exports.WorkType = exports.ContractType = exports.DepartmentCategory = exports.JobPosition = exports.PayGrade = exports.EmployeeStatus = exports.MaritalStatus = exports.Gender = void 0;
var Gender;
(function (Gender) {
    Gender["MALE"] = "MALE";
...
(function (PayGrade) {
    ...
    PayGrade["PG4"] = "PG4";
    PayGrade["PG5"] = "PG5";
    PayGrade["EXECUTIVE"] = "EXECUTIVE";
})(PayGrade || (exports.PayGrade = PayGrade = {}));
var JobPosition;
(function (JobPosition) {
    JobPosition["INTERN"] = "INTERN";
    JobPosition["JUNIOR"] = "JUNIOR";
    JobPosition["MID"] = "MID";
    JobPosition["SENIOR"] = "SENIOR";
    JobPosition["LEAD"] = "LEAD";
    JobPosition["MANAGER"] = "MANAGER";
    JobPosition["DIRECTOR"] = "DIRECTOR";
    JobPosition["VP"] = "VP";
    JobPosition["C_LEVEL"] = "C_LEVEL";
})(JobPosition || (exports.JobPosition = JobPosition = {}));
var DepartmentCategory;
(function (DepartmentCategory) {
    DepartmentCategory["ENGINEERING"] = "ENGINEERING";
    DepartmentCategory["HR"] = "HR";
    DepartmentCategory["FINANCE"] = "FINANCE";
    DepartmentCategory["OPERATIONS"] = "OPERATIONS";
    DepartmentCategory["SALES"] = "SALES";
    DepartmentCategory["MARKETING"] = "MARKETING";
    DepartmentCategory["IT"] = "IT";
    DepartmentCategory["LEGAL"] = "LEGAL";
    DepartmentCategory["PROCUREMENT"] = "PROCUREMENT";
    DepartmentCategory["OTHER"] = "OTHER";
})(DepartmentCategory || (exports.DepartmentCategory = DepartmentCategory = {}));
var ContractType;
