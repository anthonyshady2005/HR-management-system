...
export class PayrollConfigurationController {
    ...
    @Roles(SystemRole.PAYROLL_SPECIALIST, SystemRole.PAYROLL_MANAGER)
    @Patch('pay-types/:id')
    async updatePayType(@Param('id') id: string, @Body() dto: UpdatePayTypeDto, @Req() req: any) {
        const userId = req.user._id.toString();
    ...
    async createTerminationBenefit(@Body() dto: CreateTerminationBenefitDto, @Req() req: any) {
        const createdBy = req.user._id.toString();
        return await this.payrollConfigService.createTerminationBenefit(dto, createdBy);
    }
    ...
    async updateTerminationBenefit(
        ...
        const userId = req.user._id.toString();
        return await this.payrollConfigService.updateTerminationBenefit(id, dto, userId);
    }
    ...
    async createInsuranceBracket(@Body() dto: CreateInsuranceBracketDto, @Req() req: any) {
        const createdBy = req.user._id.toString();
        return await this.payrollConfigService.createInsuranceBracket(dto, createdBy);
    }
    ...
    async updateInsuranceBracket(
        ...
        const userId = req.user._id.toString();
        return await this.payrollConfigService.updateInsuranceBracket(id, dto, userId);
    }
    ...
    async updateCompanySettings(@Param('id') id: string, @Body() dto: UpdateCompanySettingsDto) {
